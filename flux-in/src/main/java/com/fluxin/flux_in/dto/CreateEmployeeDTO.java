...
public record CreateEmployeeDTO(@NotBlank(message = "Preencha o nome do funcionário.") String name,
                                ...
                                @NotNull(message = "Expediente deve ser informado.") @Valid WorkingHourDTO workingHourDTO) {
